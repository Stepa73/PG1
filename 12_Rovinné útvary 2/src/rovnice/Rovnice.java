        ...
        switch (rovnice) {
            ...
            case "c": {
                ...
                if (ak + bk > ck && ak + ck > bk && bk + ck > ak) {
                    System.out.println("Zadané rozměry u trojúhelníku byli správně.");
                } else {
                    System.out.println("Zadané rozměry u trojúhelníku jsou špatně tudíž i výpočet. U trojúhelníku platí, že součet jakých koliv dvou stran v trojúhelníku musí být větší než třetí strana.");
                }
                break;
            }
            default: {
                System.out.println("Špatná odpověď pro příště odpovídej pouze malými písmeny a,b nebo c");
            }
        }
    }
}
