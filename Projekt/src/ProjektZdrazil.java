...
public class ProjektZdrazil extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("TAXÍK METR :D");

        jTextArea1.setEditable(false);
        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("0-19km........25 kč/km\n20-39km.......23 kč/km\n40-59km.......20 kč/km\n60km a více...17 kč/km");
        jScrollPane1.setViewportView(jTextArea1);

        jTextField1.setText("zde zadej km");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProjektZdrazil dialog = new ProjektZdrazil(new javax.swing.JFrame(), true);
